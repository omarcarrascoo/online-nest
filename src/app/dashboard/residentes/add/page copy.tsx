...
export default function AddResident(): JSX.Element {
  ...
  // Estilos coherentes con el look & feel (input ghost + label flotante)
  const baseInput =
  ...
  const labelFloat =
    "pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-white/60 " +
    "transition-all duration-200 peer-focus:-top-2 peer-focus:translate-y-0 peer-focus:text-xs " +
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const payload = sanitizeForm(form);
      await apiClient.post("/residents", payload);
      // Nota: tu sidebar usa /dashboard/residentes. Ajusta si es necesario.
  ...
  return (
    <div className="max-w-6xl mx-auto my-8 px-4">
      {/* Título estilo glass con gradient */}
      <div className="mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section className="relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
          <h2 className="flex items-center text-lg font-semibold mb-4 text-white">
            <UserIcon className="h-5 w-5 mr-2 text-teal-200" />
            Información General
          </h2>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className={fieldWrap}>
              ...
              <label className={`${labelFloat} -top-2 translate-y-0 text-xs`}>
                Estado
              </label>
            </div>
        ...
        <section className="relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
          <h2 className="flex items-center text-lg font-semibold mb-4 text-white">
            <CurrencyDollarIcon className="h-5 w-5 mr-2 text-teal-200" />
            Información de Arrendamiento
          </h2>
        ...
        <section className="relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
          <h2 className="flex items-center text-lg font-semibold mb-4 text-white">
            <TagIcon className="h-5 w-5 mr-2 text-teal-200" />
            Extras
          </h2>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className={fieldWrap}>
              <input
                ...
                className={`peer ${baseInput} ${focusable}`}
              />
              <label className={labelFloat}>Etiquetas (separadas por comas)</label>
            </div>
